...
function Faq() {
  ...
  return (
    <div className="faq">
      <section className="faq-section max-width">
        <div className="container">
          <div className="faq-content">
            <div className="faq-content__title">
              <h5 className="absolute-center faq-smal ">FAQ</h5>
              <h2 className="absolute-center faq-big ">
                Frequently Asked Questions
              </h2>
              <p className="absolute-center faq-text ">
